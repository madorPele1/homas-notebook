    ...
    >
      <div style={{ textAlign: "center", flex: 1 }}>
        ...
        <div style={{ padding: "2rem 2rem 1rem 2rem", fontSize: "2.4vh" }}>
          ...
          ></div>
          <p style={{fontWeight: 'bold', color: "rgb(45, 146, 148)"}}>
            אינני יודע מה המתכון לתפקוד מיטבי של ק' חומ"ס, אבל בטח לא יזיק לפתוח
            פנקס נתונים תחילה.
          </p>
          <p>
            פנקס נתונים <b style={{color: "rgb(45, 146, 148)"}}>לא מחליף</b> את הספרות המקצועית העשירה בתחום החומרים
            המסוכנים שנכתבה בפיקוד העורף.
          </p>
          <p>
            הפנקס <b style={{color: "rgb(45, 146, 148)"}}>נועד לתמצת ולהנגיש</b> את המידע המקצועי, את הנהלים, את ההוראות
